...
import { requireKickAppAccessToken, validateActiveLivestreamsRequest, } from "./validation.js";
export function createKickLivestreamsClient(options) {
    return {
        /**
        ...
        async getActive(request) {
            ...
            const appAccessToken = requireKickAppAccessToken(options.appAccessToken, "livestreams.getActive()");
            ...
            const stream = {
                ...
                status: "live",
                concurrentViewers: typeof item.stream?.viewer_count === "number"
