...
export type TwitchLivestreamsClient = {
    ...
    getActive(request: TwitchActiveLivestreamsRequest): Promise<Livestream<"twitch">[]>;
    /** Fetch scheduled streams for a Twitch broadcaster. */
    getScheduled(request: TwitchScheduledLivestreamsRequest): Promise<Livestream<"twitch">[]>;
};
/**
